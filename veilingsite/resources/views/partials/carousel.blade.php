<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a href="#myCarousel" title="#myCarousel prev" class="left carousel-control" data-slide="prev">
        <span class="pull-left margin-top-15"><img src="{{ asset('images/elements/arrow-left-home.png') }}" title="arrow-left-home"  alt="left-arrow"></span>
        <span class="sr-only">Previous</span>
    </a>

    <a href="#myCarousel" title="#myCarousel next" class="right carousel-control" data-slide="next">
        <span class="pull-right margin-top-15"><img src="{{ asset('images/elements/arrow-right-home.png') }}" title="arrow-right-home" alt="left-arrow"></span>
