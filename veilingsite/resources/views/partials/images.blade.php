<div class="full-width background-light-grey">
    <div class="container">
        <div class="row">
            <div class="grid-x grid-margin-x text-center">
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-12 col-sm-12 margin-top-2 margin-bottom-2">
                        <h3 class="midnight-blue" >Most popular this week <img class="rotate-90" src="{{ asset('images/elements/arrow-down.png') }}" alt="arrow-down">
                        </h3>
                        <div class="col-sm-12 col-md-12 col-xs-12">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-8 margin-bottom-2">
