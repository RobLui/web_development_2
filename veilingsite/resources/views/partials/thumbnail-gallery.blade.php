<div class="container col-md-12 col-sm-12 margin-bottom-3 margin-top-2">
    <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12">
            <div class="col-md-12 col-sm-12">
                <h3 class="midnight-blue margin-bottom-1">Related Items</h3>
            </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="col-sm-12">
                    <div class="bordered-bottom">
                        ...
                        <button class="padding-complete midnight-blue bordered-complete margin-left-half">visit auction ></button>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-3 margin-left-images-minus">
                ...
                <div class="col-sm-12">
                    <span class="light-dark-grey">25d 14u 44m</span>
                    <button class="padding-complete midnight-blue bordered-complete">visit auction ></button>
                </div>
            </div>
